...
from opentelemetry.pyproto._pyprotobuf.fields import _msg, _u64
...
class Resource:
    ...
    def SerializeToString(self) -> bytes:
        return (
            b"".join(_msg(1, kv.SerializeToString()) for kv in self.attributes)
            + _u64(2, self.dropped_attributes_count)
        )
