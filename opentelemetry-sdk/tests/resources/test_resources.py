...
from opentelemetry.sdk.environment_variables import OTEL_RESOURCE_DETECTORS
...
class TestOTELResourceDetector(unittest.TestCase):
    ...
    def test_multiple(self):
        ...
        self.assertEqual(
            detector.detect(), Resource({"k": "v", "k2": "v2"})
        )
    ...
    @patch.dict(environ, {OTEL_RESOURCE_DETECTORS: "mock"}, clear=True)
    @patch(
