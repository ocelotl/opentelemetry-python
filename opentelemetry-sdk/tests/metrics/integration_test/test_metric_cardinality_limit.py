...
class TestCardinalityLimit(TestCase):
    ...
    def test_reader_cardinality_limit_overflows_at_reader_limit(self):
        ...
        reader_limit = 10
        data_points = self._record_distinct_attribute_sets(reader_limit + 20, cardinality_limit=reader_limit)
    ...
    def test_reader_cardinality_limit_no_overflow_below_reader_limit(self):
        ...
        reader_limit = 10
        data_points = self._record_distinct_attribute_sets(reader_limit - 1, cardinality_limit=reader_limit)
    ...
    def test_reader_cardinality_limit_unset_falls_back_to_default(self):
        ...
        data_points = self._record_distinct_attribute_sets(_DEFAULT_CARDINALITY_LIMIT + 100)
    ...
    @staticmethod
    def _record_distinct_attribute_sets_with_view(count, view_limit=None, reader_limit=None):
        ...
        meter_provider = MeterProvider(metric_readers=[reader], views=[view])
        meter = meter_provider.get_meter("testmeter")
        counter = meter.create_counter("testcounter")
    ...
    def test_view_cardinality_limit_overflows_at_view_limit(self):
        ...
        view_limit = 10
        data_points = self._record_distinct_attribute_sets_with_view(view_limit + 20, view_limit=view_limit)
